/*** Autogenerated by WIDL 4.12.1 from /Users/gcenx/Downloads/CROSSOVER19.0.1/sources/wine/include/dwrite_3.idl - Do not edit ***/
...
{
    virtual HANDLE STDMETHODCALLTYPE GetExiprationEvent(
        ) = 0;
...
typedef struct IDWriteFontCollection3Vtbl {
    ...
    HANDLE (STDMETHODCALLTYPE *GetExiprationEvent)(
        IDWriteFontCollection3 *This);
...
/*** IDWriteFontCollection3 methods ***/
#define IDWriteFontCollection3_GetExiprationEvent(This) (This)->lpVtbl->GetExiprationEvent(This)
#else
/*** IUnknown methods ***/
...
/*** IDWriteFontCollection3 methods ***/
static FORCEINLINE HANDLE IDWriteFontCollection3_GetExiprationEvent(IDWriteFontCollection3* This) {
    return This->lpVtbl->GetExiprationEvent(This);
}
#endif
#endif
