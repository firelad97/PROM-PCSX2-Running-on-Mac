/*** Autogenerated by WIDL 4.12.1 from /Users/gcenx/Downloads/CROSSOVER19.0.1/sources/wine/include/wmp.idl - Do not edit ***/
...
typedef enum __WIDL_wmp_generated_name_00000012 {
    wmppsUndefined = 0,
    wmppsStopped = 1,
    wmppsPaused = 2,
    wmppsPlaying = 3,
...
typedef enum __WIDL_wmp_generated_name_00000013 {
    wmplcUnknown = 0,
    wmplcClear = 1,
    wmplcInfoChange = 2,
    wmplcMove = 3,
...
typedef enum __WIDL_wmp_generated_name_00000014 {
    wmpdsUnknown = 0,
...
typedef enum __WIDL_wmp_generated_name_00000015 {
    wmpssUnknown = 0,
...
typedef enum __WIDL_wmp_generated_name_00000016 {
    wmprsUnknown = 0,
    wmprsRipping = 1,
    wmprsStopped = 2
} WMPRipState;
typedef enum __WIDL_wmp_generated_name_00000017 {
    wmpbfAudioCD = 0,
    wmpbfDataCD = 1
} WMPBurnFormat;
typedef enum __WIDL_wmp_generated_name_00000018 {
    wmpbsUnknown = 0,
    wmpbsBusy = 1,
    wmpbsReady = 2,
...
typedef enum __WIDL_wmp_generated_name_00000019 {
    wmpltUnknown = 0,
    wmpltAll = 1,
    wmpltLocal = 2,
    wmpltRemote = 3,
...
typedef enum __WIDL_wmp_generated_name_0000001A {
    wmpfssUnknown = 0,
    wmpfssScanning = 1,
    wmpfssUpdating = 2,
    wmpfssStopped = 3
} WMPFolderScanState;
typedef enum __WIDL_wmp_generated_name_0000001B {
    wmpsccetUnknown = 0,
    wmpsccetInsert = 1,
    wmpsccetChange = 2,
    wmpsccetDelete = 3,
